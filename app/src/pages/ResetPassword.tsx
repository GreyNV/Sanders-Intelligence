    ...
    <div className="min-h-screen bg-bg flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <div className="text-text2 text-sm mt-1">Set your password</div>
        </div>

        <div className="card">
          <h1 className="text-base font-semibold text-text1 mb-5">Create a password</h1>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-text2 mb-1.5">New password</label>
              <input
                type="password"
                required
                minLength={8}
